...
def welcomepic(pic, user, chatname, id, uname):
    background = Image.open("helper/rj/Brandedwel2.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp)
    pfp = pfp.resize((825, 824))
    draw = ImageDraw.Draw(background)
    font = ImageFont.truetype('helper/rj/font.ttf', size=110)
    welcome_font = ImageFont.truetype('helper/rj/font.ttf', size=60)
