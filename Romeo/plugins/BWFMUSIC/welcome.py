...
from Romeo.utils.jarvis_ban import admin_filter
import os
...
def welcomepic(pic, user, chatname, id, uname):
    background = Image.open("helper/rj/annie/AnnieNwel.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp)
    pfp = pfp.resize((835, 839))
    draw = ImageDraw.Draw(background)
    font_large = ImageFont.truetype('helper/rj/annie/ArialReg.ttf', size=65)
    font_small = ImageFont.truetype('helper/rj/annie/ArialReg.ttf', size=60)
